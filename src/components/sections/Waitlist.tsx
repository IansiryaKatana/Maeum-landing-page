    ...
    >
      <div className="relative max-w-[1040px] mx-auto">
        <div className="relative waitlist-fade w-full h-[650px] md:h-[640px] rounded-3xl bg-transparent px-8 py-12 md:px-16 md:py-16">
          ...
          />
          <div className="relative z-10 h-full flex flex-col items-center justify-center text-center -rotate-[7.5deg] md:-rotate-[3deg]">
            ...
            <button
              className="group relative inline-flex items-center justify-center gap-1.5 w-full max-w-[240px] md:w-auto md:max-w-none min-w-0 md:min-w-[620px] font-myungjo uppercase text-[11px] md:text-[52px] leading-none tracking-[0.01em] whitespace-nowrap px-4 md:px-12 py-3 md:py-5 bg-[#c81b17] text-[#f6ead0] rounded-[12px] md:rounded-[20px] rotate-[-2deg] shadow-[0_14px_30px_rgba(0,0,0,0.28),0_0_22px_rgba(236,214,170,0.45)] transition-all duration-300 hover:scale-[1.01] hover:brightness-105 active:scale-[0.995]"
              onClick={() => {
                const el = document.getElementById("waitlist-form");
                el?.scrollIntoView({ behavior: "smooth" });
              }}
            >
              <span className="pointer-events-none absolute inset-[7px] rounded-[14px] border border-[#f1dbb7]/80" />
